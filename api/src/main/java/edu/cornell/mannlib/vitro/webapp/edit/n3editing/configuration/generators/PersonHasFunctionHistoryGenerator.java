...
public class PersonHasFunctionHistoryGenerator extends VivoBaseGenerator implements EditConfigurationGenerator {
    ...
    final static String EHESS_Affiliation_IRI = "http://data.ehess.fr/ontology/vivo-fr#EHESS-Affiliation";
    ...
    final static String[] preciseFunctionClasses = { vivofr + "FNC_0000008", vivofr + "FNC_0000009",
            vivofr + "FNC_0000010", vivofr + "FNC_0000011", vivofr + "FNC_0000012", vivofr + "FNC_0000013",
            vivofr + "FNC_0000014", vivofr + "FNC_0000015", vivofr + "FNC_0000016", vivofr + "FNC_0000017",
            vivofr + "FNC_0000018", vivofr + "FNC_0000019", vivofr + "FNC_0000020", vivofr + "FNC_0000021" };
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq, HttpSession session) throws Exception {
        ...
        conf.setN3Required(Arrays.asList(n3ForNewFunction, functionTypeAssertion, keepLabelAssertion));
        ...
        conf.addField(new FieldVTwo().setName("functionTitle").setRangeDatatypeUri(XSD.xstring.toString()));

        conf.addField(new FieldVTwo().setName("functionType").setValidators(list("nonempty"))
                .setOptions(new RdfTypeOptions(ArrayUtils.addAll(genericFunctionClasses, preciseFunctionClasses))));
        ...
        /*
         * Configuration du menu déroulant 'Type d'organisation'
         */
        conf.addField(new FieldVTwo().setName("orgType")
                .setOptions(GeneratorUtil.buildConstantFieldOptions(vreq, EHESS_AffiliateQuery)));
        ...
        conf.addValidator(new RelationshipMandatoryLabelValidator("functionType", "functionTitle",
                preciseFunctionClasses, msgErreur));
    ...
    /*
     * Recherche des organisations qui sont des affiliations à l'EHESS
     */
    final static String EHESS_AffiliateQuery = "PREFIX rdfs: <" + rdfs + "> \n" + "DESCRIBE ?existingOrgType WHERE { \n"
            + "  ?existingOrgType rdfs:subClassOf <" + EHESS_Affiliation_IRI + "> " + "} ";

    final static String n3ForNewFunction = "@prefix core: <" + vivoCore + "> . \n"
            + "?person core:relatedBy  ?function . \n" + "?function a  ?functionType . \n" + "?function <"
            + keepLabelPred + ">  ?keepLabel . \n" + "?function core:relates ?person ; ";

    final static String functionTitleAssertion = "?function <" + label + "> ?functionTitle .";

    final static String functionTypeAssertion = "?function a ?functionType .";

    final static String keepLabelAssertion = "?function <" + keepLabelPred + "> ?keepLabel .";

    final static String n3ForNewOrg = "?function <" + functionInOrgPred + "> ?newOrg . \n" + "?newOrg <"
            + orgForFunctionPred + "> ?function . \n" + "?newOrg <" + label + "> ?orgLabel . \n"
            + "?newOrg a ?orgType .";

    final static String n3ForExistingOrg = "?function <" + functionInOrgPred + "> ?existingOrg . \n" + "?existingOrg <"
            + orgForFunctionPred + "> ?function . \n" + "?existingOrg a ?orgType .";

    final static String n3ForStart = "?function <" + functionToInterval + "> ?intervalNode . \n" + "?intervalNode a <"
            + intervalType + "> . \n" + "?intervalNode <" + intervalToStart + "> ?startNode . \n" + "?startNode a <"
            + dateTimeValueType + "> . \n" + "?startNode  <" + dateTimeValue + "> ?startField-value . \n"
            + "?startNode  <" + dateTimePrecision + "> ?startField-precision . \n";

    final static String n3ForEnd = "?function <" + functionToInterval + "> ?intervalNode . \n" + "?intervalNode a <"
            + intervalType + "> . \n" + "?intervalNode <" + intervalToEnd + "> ?endNode . \n" + "?endNode a <"
            + dateTimeValueType + "> . \n" + "?endNode  <" + dateTimeValue + "> ?endField-value . \n" + "?endNode  <"
            + dateTimePrecision + "> ?endField-precision . \n";

    // Queries for existing values
    final static String orgLabelQuery = "SELECT ?existingOrgLabel WHERE { \n" + "  ?function <" + functionInOrgPred
            + "> ?existingOrg . \n" + "  ?existingOrg a <" + orgClass + "> . \n" + "  ?existingOrg <" + label
            + "> ?existingOrgLabel . \n" + "}";

    final static String functionTitleQuery = "SELECT ?existingFunctionTitle WHERE { \n" + "?function <" + label
            + "> ?existingFunctionTitle . }";
    ...
    final static String existingStartDateQuery = "SELECT ?existingDateStart WHERE { \n" + "  ?function <"
            + functionToInterval + "> ?intervalNode . \n" + "  ?intervalNode a <" + intervalType + "> . \n"
    ...
    final static String existingDesignationQuery = "SELECT ?existingOrg WHERE { \n" + "  ?function <"
            + functionInOrgPred + "> ?existingOrg . \n" + "  ?existingOrg a <" + orgClass + ">  }";
    ...
    // returning thing
    final static String functionTypeQuery = "PREFIX vitro: <" + VitroVocabulary.vitroURI + "> \n"
    ...
    final static String existingIntervalNodeQuery = "SELECT ?existingIntervalNode WHERE { \n" + "  ?function <"
            + functionToInterval + "> ?existingIntervalNode . \n" + "  ?existingIntervalNode a <" + intervalType
            + "> . }";
