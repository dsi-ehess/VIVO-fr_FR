 ...
 */
public class ClassPeopleGroupPageData extends DataGetterBase implements DataGetter{

    private static final Log log = LogFactory.getLog(ClassPeopleGroupPageData.class);
     ...
     */
    public ClassPeopleGroupPageData(VitroRequest vreq, Model displayModel, String dataGetterURI){
