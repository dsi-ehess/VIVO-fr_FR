 ...
 */
@WebServlet(name = "DeletePropertyControllerBis", urlPatterns = {"/deletePropertyControllerBis"})
public class DeletePropertyControllerBis extends FreemarkerHttpServlet {
    private static final Log log = LogFactory.getLog(DeletePropertyControllerBis.class);
    ...
    protected ResponseValues processRequest(VitroRequest vreq) {
        ...
        /**
         *  HACK EHESS Handle second URI to delete in "statutory membership" form
         */
        if (StringUtils.isNotBlank(getDelectSecondaryObjectUri(vreq))) {
            deleteSecondObjectIndividual(vreq);
        }
        //HACK EHESS END
    ...
    //HACK EHESS
    public static String getDelectSecondaryObjectUri(VitroRequest vreq) {
        return vreq.getParameter("deleteSecondaryObjectUri");
    }

    private void deleteSecondObjectIndividual(VitroRequest vreq) {
        String objectUri = getDelectSecondaryObjectUri(vreq);
        Individual object = getObjectIndividualForDeletion(vreq, objectUri);
        if (object != null) {
            log.warn("Deleting secondary team membership : " + object.getName() );
