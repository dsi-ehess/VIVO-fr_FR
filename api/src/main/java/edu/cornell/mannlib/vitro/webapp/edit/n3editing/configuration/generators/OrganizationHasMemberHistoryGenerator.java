...
public abstract class OrganizationHasMemberHistoryGenerator extends VivoBaseGenerator
	...
	public abstract String getMemberClass();
	public abstract String getTargetMemberClass();
	...
	public String getN3NewPosition() {
		...
		return "@prefix core: <http://vivoweb.org/ontology/core#> . \n"
				...
				+ "?position a <" + getMemberClass() + "> . \n"
				+ "?position core:relates ?organization . ";
	}

    public String getN3NewPerson() {
		 return "@prefix core: <http://vivoweb.org/ontology/core#> . \n"
				+ "@prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> . \n"
				+ "@prefix foaf: <http://xmlns.com/foaf/0.1/> . \n"
				+ "?position core:relates ?person . \n"
				+ "?person core:relatedBy ?position . \n"
				+ "?person a <" + getTargetMemberClass() + "> . \n"
	...
	public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
		...
		conf.setN3Required(Arrays.asList(getN3NewPosition()));
		conf.setN3Optional(Arrays.asList(getN3NewPerson(), N3_EXISTING_PERSON, N3_NEW_START_NODE, N3_NEW_END_NODE, N3_NEW_FIRST_NAME, N3_NEW_LAST_NAME));
