...
public class OrganizationHasStatutoryMemberHistoryGenerator extends VivoBaseGenerator
		implements EditConfigurationGenerator {

	private final static String NS_VIVO_CORE = "http://vivoweb.org/ontology/core#";
	private final static String NS_EHESS_CORE = "http://data.ehess.fr/ontology/vivo#";
	...
	private final static String URI_ASSOCIATE_MEMBERSHIP_CLASS = NS_EHESS_CORE + "AppartenanceStatutaire";

	private final static String statutoryMembershipLabel = "\"Appartenance statutaire\"@fr , \"StatutoryMembership\"@en" ;
	...
	private static final String N3_NEW_POSITION = ""
			...
			+ "?position a ehess:AppartenanceStatutaire . \n"
	        + "?position <" + label + "> " + statutoryMembershipLabel + " . \n"
	...
	public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
		...
		conf.setTemplate("organizationHasStatutoryMemberHistory.ftl");
		...
		conf.setUrisOnform(Arrays.asList("existingPerson", "position"));
		...
		conf.setLiteralsOnForm(Arrays.asList("personLabelDisplay", "personLabel", "firstName", "lastName"));
