...
public abstract class PersonHasMemberHistoryGenerator extends VivoBaseGenerator implements
    ...
    public PersonHasMemberHistoryGenerator() {}
    ...
    public abstract String getAssociateClass();
    public abstract String getTemplate();
    public abstract String getAssociateClassLabel();
    @Override
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        conf.setTemplate(getTemplate());

        conf.setVarNameForSubject("person");
        conf.setVarNameForPredicate("predicate");
        conf.setVarNameForObject("associateMember");
        conf.setVarNameForObject("position");


        conf.setN3Required( Arrays.asList(getN3ForNewPosition(), n3ForExistingOrg ) );
        conf.setN3Optional( Arrays.asList(n3ForNewOrg, n3ForStart, n3ForEnd ) );

        conf.addNewResource("position", DEFAULT_NS_FOR_NEW_RESOURCE);
        conf.addNewResource("associateMember", DEFAULT_NS_FOR_NEW_RESOURCE);
        ...
        //conf.setUrisOnform(Arrays.asList("existingOrg", "orgType"));
        conf.setUrisOnform(Arrays.asList("existingOrg"));
    ...
    public String getN3ForNewPosition() {
        return "@prefix core: <"+ vivoCore +"> .\n"+
                "?person core:relatedBy  ?position . \n" +
                "?position a  <" + getAssociateClass() + ">. \n" +
                "?position <" + label + "> " + getAssociateClassLabel() + " . \n" +
