...
<#-- this template is for adding a person's statutory Membership to an organization -->
...
<h2>${titleVerb}&nbsp;${i18n().statutorymember_history_entry_for} ${editConfiguration.subjectName}</h2>
...
<section id="organizationHasPositionHistory" role="region">
	...
	<form id="organizationHasStatutoryMembershipHistory" class="customForm noIE67" action="${submitUrl}"  role="add/edit statutory membership history">
  	    <p>
