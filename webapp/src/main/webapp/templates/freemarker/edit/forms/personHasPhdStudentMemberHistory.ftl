...
<#assign existingUnitComponentValue = lvf.getFormFieldValue(editSubmission, editConfiguration, "existingUnitComponent")/>
<#assign unitComponentLabelValue = lvf.getFormFieldValue(editSubmission, editConfiguration, "unitComponentLabel")/>
<#assign unitComponentLabelDisplayValue = lvf.getFormFieldValue(editSubmission, editConfiguration, "unitComponentLabelDisplay")/>
...
<h2>${formAction} ${i18n().phdstudent_entry_for} ${editConfiguration.subjectName}</h2>

<#--Display error messages if any-->
<#if submissionErrors?has_content>
    <#list submissionErrors?keys as key>
...
var customFormData  = {
    ...
    acTypes: {organization: 'http://data.ehess.fr/ontology/vivo#UniteDeRecherche,http://data.ehess.fr/ontology/vivo#ComposanteDUnite'},
    acSelectOnly: 'true',
